...
# Additional packages
pacman -S base-devel networkmanager vim firefox discord git sudo noto-fonts xorg-server xorg-xinit alacritty pulseaudio pavucontrol man-db man-pages bash-completion 
